...
public class WaterSortSearch extends GenericSearch {
    ...
    public static int calculateHeuristicCost2(WaterSearchState state) {
        ...
        System.out.println("Step 2: Calculate the number of bottles required for each color");
        for (Map.Entry<Character, Integer> mapElement : colorToColorCountMap.entrySet()) {
            Integer numOfColorOccurrence = mapElement.getValue();
            System.out.println("Color " + mapElement.getKey() + ", numOfColorOccurrence " + numOfColorOccurrence);
            numberOfBottlesNeeded += (int) Math.ceil((double)(numOfColorOccurrence/state.bottleCapacity));
            System.out.println("Color " + mapElement.getKey() + ", numberOfBottlesNeeded " + numberOfBottlesNeeded);
        }
        ...
        System.out.println("Step 1: Set the color of each bottle based on the largest occurrence of a colored layer in the bottle");
        for (int i = 0; i < arrayOfColoredLabels.length; i++) {
            System.out.println("Bottle " + i + ": " + arrayOfColoredLabels[i].first);
        }
        ...
        for (Map.Entry<Character, Integer> mapElement : colorToColorCountMap.entrySet()) {
            ...
            System.out.println(state.bottleCapacity);
            System.out.println("currentColor: " + currentColor + ", numOfColorOccurrence: " + numOfColorOccurrence + ", numberOfBottlesNeeded: " + numberOfBottlesNeeded);
